...
class MobileNetV3(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.output_layer = GDC(in_channels=lastconv_output_channels, embedding_dim=embedding_dim)
...
def mobilenet_v3_large(embedding_dim: int = 512, **kwargs: Any) -> MobileNetV3:

    inverted_residual_setting, last_channel = _mobilenet_v3_conf("mobilenet_v3_large", **kwargs)
    return MobileNetV3(inverted_residual_setting, last_channel, embedding_dim=embedding_dim,  **kwargs)


def mobilenet_v3_small(embedding_dim: int = 512, **kwargs: Any) -> MobileNetV3:
